import * as narrate from './narrator.js?v=20260907d';
...
export const OFFICIAL_CARDS = [
    ...
    // =============================================
    // 📜 EASY HIT ACT — héroes del primer diseño original del juego
    // Rescatados de "easy hit ACT.docx"/.pdf. Stats reescalados al presupuesto
    // de 7400 preservando la proporción POT/DEF/Vida original. passiveId apunta
    // a un texto en passiveNames (ui.js) sin lógica de combate todavía —
    // se implementará más adelante, carta por carta.
    // =============================================

    {
        ...
        element: 'Oscuridad',
        cardClass: 'Neutral',
        hp: 2050, def: 2050, atq: 3100,
        maxHp: 2050,
        passiveId: 'orig_hades',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Hades',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_shadow_hunter',
        name: 'Shadow Hunter',
        element: 'Oscuridad',
        cardClass: 'Spectre',
        hp: 850, def: 850, atq: 850,
        maxHp: 850,
        passiveId: 'orig_shadow_hunter',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Shadow%20Hunter',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_guardian_de_la_puerta',
        name: 'Guardian de la puerta',
        element: 'Luz',
        cardClass: 'Human',
        hp: 950, def: 700, atq: 1100,
        maxHp: 950,
        passiveId: 'orig_guardian_de_la_puerta',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Guardian%20de%20la%20puerta',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_malmortius',
        name: 'Malmortius',
        element: 'Oscuridad',
        cardClass: 'Monster',
        hp: 2700, def: 2200, atq: 2350,
        maxHp: 2700,
        passiveId: 'orig_malmortius',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Malmortius',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Agua',
        cardClass: 'Human',
        hp: 950, def: 1050, atq: 850,
        maxHp: 950,
        passiveId: 'orig_tirzah',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Tirzah',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_caperucita_vanessa',
        name: 'Caperucita Vanessa',
        element: 'Naturaleza',
        cardClass: 'Human',
        hp: 750, def: 1100, atq: 800,
        maxHp: 750,
        passiveId: 'orig_caperucita_vanessa',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Caperucita%20Vanessa',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Rayo',
        cardClass: 'Spectre',
        hp: 1050, def: 1450, atq: 2300,
        maxHp: 1050,
        passiveId: 'orig_kikuri',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Kikuri',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_gioconda_y_muerte',
        name: 'Gioconda y Muerte',
        element: 'Oscuridad',
        cardClass: 'Spectre',
        hp: 150, def: 50, atq: 5900,
        maxHp: 150,
        passiveId: 'orig_gioconda_y_muerte',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Gioconda%20y%20Muerte',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_rey_altajerjes',
        name: 'Rey Altajerjes',
        element: 'Fuego',
        cardClass: 'Human',
        hp: 2350, def: 750, atq: 1050,
        maxHp: 2350,
        passiveId: 'orig_rey_altajerjes',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Rey%20Altajerjes',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_kaligula',
        name: 'Kaligula',
        element: 'Oscuridad',
        cardClass: 'Human',
        hp: 1150, def: 1050, atq: 4750,
        maxHp: 1150,
        passiveId: 'orig_kaligula',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Kaligula',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_valkyria',
        name: 'Valkyria',
        element: 'Luz',
        cardClass: 'Viking',
        hp: 1000, def: 1600, atq: 700,
        maxHp: 1000,
        passiveId: 'orig_valkyria',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Valkyria',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Fuego',
        cardClass: 'Human',
        hp: 1550, def: 650, atq: 950,
        maxHp: 1550,
        passiveId: 'orig_ares',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Ares',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Oscuridad',
        cardClass: 'Monster',
        hp: 1650, def: 1500, atq: 4250,
        maxHp: 1650,
        passiveId: 'orig_skorteo',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Skorteo',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Naturaleza',
        cardClass: 'Human',
        hp: 1800, def: 450, atq: 450,
        maxHp: 1800,
        passiveId: 'orig_siseron',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Siser%C3%B3n',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_angosto_vackhir',
        name: 'Angosto Vackhir',
        element: 'Oscuridad',
        cardClass: 'Spectre',
        hp: 950, def: 1100, atq: 650,
        maxHp: 950,
        passiveId: 'orig_angosto_vackhir',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Angosto%20Vackhir',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_incorporeo',
        name: 'Incorpóreo',
        element: 'Oscuridad',
        cardClass: 'Spectre',
        hp: 1350, def: 3350, atq: 1350,
        maxHp: 1350,
        passiveId: 'orig_incorporeo',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Incorp%C3%B3reo',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_pisro_lan',
        name: 'Pisro Lan',
        element: 'Agua',
        cardClass: 'Human',
        hp: 850, def: 700, atq: 1300,
        maxHp: 850,
        passiveId: 'orig_pisro_lan',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Pisro%20Lan',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_bruneleski',
        name: 'Bruneleski',
        element: 'Rayo',
        cardClass: 'Robot',
        hp: 1700, def: 1350, atq: 3100,
        maxHp: 1700,
        passiveId: 'orig_bruneleski',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Bruneleski',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_freewolf',
        name: 'Freewolf',
        element: 'Naturaleza',
        cardClass: 'Beast',
        hp: 900, def: 900, atq: 900,
        maxHp: 900,
        passiveId: 'orig_freewolf',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Freewolf',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_mago_de_rivenhelm',
        name: 'Mago de Rivenhelm',
        element: 'Rayo',
        cardClass: 'Human',
        hp: 1950, def: 350, atq: 350,
        maxHp: 1950,
        passiveId: 'orig_mago_de_rivenhelm',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Mago%20de%20Rivenhelm',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_maestro_xin',
        name: 'Maestro Xin',
        element: 'Rayo',
        cardClass: 'Human',
        hp: 1250, def: 1450, atq: 500,
        maxHp: 1250,
        passiveId: 'orig_maestro_xin',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Maestro%20Xin',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_ghaz_rankha',
        name: 'Ghaz-Rankha',
        element: 'Fuego',
        cardClass: 'Monster',
        hp: 850, def: 1150, atq: 1100,
        maxHp: 850,
        passiveId: 'orig_ghaz_rankha',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Ghaz-Rankha',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_aristoteles',
        name: 'Aristoteles',
        element: 'Luz',
        cardClass: 'Human',
        hp: 550, def: 2100, atq: 300,
        maxHp: 550,
        passiveId: 'orig_aristoteles',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Aristoteles',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Luz',
        cardClass: 'Neutral',
        hp: 1550, def: 1550, atq: 50,
        maxHp: 1550,
        passiveId: 'orig_chronos',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Chronos',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Agua',
        cardClass: 'Human',
        hp: 1800, def: 900, atq: 450,
        maxHp: 1800,
        passiveId: 'orig_johann',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Johann',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Oscuridad',
        cardClass: 'Spectre',
        hp: 1200, def: 1000, atq: 850,
        maxHp: 1200,
        passiveId: 'orig_olher',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Olher',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_giberti_de_luz',
        name: 'Giberti de Luz',
        element: 'Luz',
        cardClass: 'Human',
        hp: 950, def: 950, atq: 950,
        maxHp: 950,
        passiveId: 'orig_giberti_de_luz',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Giberti%20de%20Luz',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_cubano_heep',
        name: 'Cubano Heep',
        element: 'Agua',
        cardClass: 'Human',
        hp: 2350, def: 3600, atq: 50,
        maxHp: 2350,
        passiveId: 'orig_cubano_heep',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Cubano%20Heep',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_armadillo_del_armaggedon',
        name: 'Armadillo del Armaggedon',
        element: 'Naturaleza',
        cardClass: 'Beast',
        hp: 850, def: 2300, atq: 150,
        maxHp: 850,
        passiveId: 'orig_armadillo_del_armaggedon',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Armadillo%20del%20Armaggedon',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_thrillseeker',
        name: 'Thrillseeker',
        element: 'Rayo',
        cardClass: 'Human',
        hp: 2550, def: 1350, atq: 3350,
        maxHp: 2550,
        passiveId: 'orig_thrillseeker',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Thrillseeker',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_akriloth_rojo',
        name: 'Akriloth Rojo',
        element: 'Fuego',
        cardClass: 'Dragon',
        hp: 1100, def: 650, atq: 450,
        maxHp: 1100,
        passiveId: 'orig_akriloth_rojo',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Akriloth%20Rojo',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_ripblood',
        name: 'Ripblood',
        element: 'Oscuridad',
        cardClass: 'Monster',
        hp: 1050, def: 1050, atq: 1100,
        maxHp: 1050,
        passiveId: 'orig_ripblood',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Ripblood',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_katarina',
        name: 'Katarina',
        element: 'Rayo',
        cardClass: 'Human',
        hp: 850, def: 600, atq: 1600,
        maxHp: 850,
        passiveId: 'orig_katarina',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Katarina',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Naturaleza',
        cardClass: 'Beast',
        hp: 2050, def: 400, atq: 600,
        maxHp: 2050,
        passiveId: 'orig_jaegger',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Jaegger',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_borgeck_haman',
        name: 'Borgeck Hamán',
        element: 'Oscuridad',
        cardClass: 'Monster',
        hp: 2850, def: 2850, atq: 1650,
        maxHp: 2850,
        passiveId: 'orig_borgeck_haman',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Borgeck%20Ham%C3%A1n',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_sheorida',
        name: 'Sheorida',
        element: 'Agua',
        cardClass: 'Human',
        hp: 950, def: 950, atq: 950,
        maxHp: 950,
        passiveId: 'orig_sheorida',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Sheorida',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_agente_nina',
        name: 'Agente Nina',
        element: 'Rayo',
        cardClass: 'Human',
        hp: 1750, def: 400, atq: 1250,
        maxHp: 1750,
        passiveId: 'orig_agente_nina',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Agente%20Nina',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_asesino_del_origami',
        name: 'Asesino del Origami',
        element: 'Oscuridad',
        cardClass: 'Human',
        hp: 300, def: 550, atq: 2000,
        maxHp: 300,
        passiveId: 'orig_asesino_del_origami',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Asesino%20del%20Origami',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_sombra_orianna',
        name: 'Sombra Orianna',
        element: 'Oscuridad',
        cardClass: 'Spectre',
        hp: 1450, def: 1550, atq: 400,
        maxHp: 1450,
        passiveId: 'orig_sombra_orianna',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Sombra%20Orianna',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Oscuridad',
        cardClass: 'Human',
        hp: 900, def: 900, atq: 1450,
        maxHp: 900,
        passiveId: 'orig_kira',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Kira',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_princesa_valyria',
        name: 'Princesa Valyria',
        element: 'Fuego',
        cardClass: 'Human',
        hp: 50, def: 900, atq: 1850,
        maxHp: 50,
        passiveId: 'orig_princesa_valyria',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Princesa%20Valyria',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_perforadora_z',
        name: 'Perforadora Z',
        element: 'Rayo',
        cardClass: 'Robot',
        hp: 250, def: 2300, atq: 50,
        maxHp: 250,
        passiveId: 'orig_perforadora_z',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Perforadora%20Z',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Agua',
        cardClass: 'Monster',
        hp: 450, def: 450, atq: 2150,
        maxHp: 450,
        passiveId: 'orig_laocont',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Laocont',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_anatreonte',
        name: 'Anatreonte',
        element: 'Naturaleza',
        cardClass: 'Monster',
        hp: 250, def: 2500, atq: 250,
        maxHp: 250,
        passiveId: 'orig_anatreonte',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Anatreonte',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Rayo',
        cardClass: 'Robot',
        hp: 700, def: 1000, atq: 1600,
        maxHp: 700,
        passiveId: 'orig_stark',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Stark',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_solomon_kane',
        name: 'Solomon Kane',
        element: 'Luz',
        cardClass: 'Human',
        hp: 800, def: 1650, atq: 1400,
        maxHp: 800,
        passiveId: 'orig_solomon_kane',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Solomon%20Kane',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_general_najenda',
        name: 'General Najenda',
        element: 'Fuego',
        cardClass: 'Human',
        hp: 950, def: 950, atq: 950,
        maxHp: 950,
        passiveId: 'orig_general_najenda',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=General%20Najenda',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_arquera_del_zen',
        name: 'Arquera del Zen',
        element: 'Naturaleza',
        cardClass: 'Human',
        hp: 1700, def: 550, atq: 550,
        maxHp: 1700,
        passiveId: 'orig_arquera_del_zen',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Arquera%20del%20Zen',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_tuarek_miravaille',
        name: 'Tuarek Miravaille',
        element: 'Agua',
        cardClass: 'Human',
        hp: 1450, def: 1850, atq: 950,
        maxHp: 1450,
        passiveId: 'orig_tuarek_miravaille',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Tuarek%20Miravaille',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_gilgamesh_miravaille',
        name: 'Gilgamesh Miravaille',
        element: 'Luz',
        cardClass: 'Human',
        hp: 1900, def: 350, atq: 1500,
        maxHp: 1900,
        passiveId: 'orig_gilgamesh_miravaille',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Gilgamesh%20Miravaille',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_zyra_miravaille',
        name: 'Zyra Miravaille',
        element: 'Naturaleza',
        cardClass: 'Human',
        hp: 1400, def: 1200, atq: 900,
        maxHp: 1400,
        passiveId: 'orig_zyra_miravaille',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Zyra%20Miravaille',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_helen_miravaille',
        name: 'Helen Miravaille',
        element: 'Luz',
        cardClass: 'Human',
        hp: 1750, def: 550, atq: 1350,
        maxHp: 1750,
        passiveId: 'orig_helen_miravaille',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Helen%20Miravaille',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Oscuridad',
        cardClass: 'Monster',
        hp: 2250, def: 2300, atq: 2700,
        maxHp: 2250,
        passiveId: 'orig_exodia',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Exodia',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_lady_flemeth',
        name: 'Lady Flemeth',
        element: 'Naturaleza',
        cardClass: 'Human',
        hp: 1350, def: 650, atq: 4150,
        maxHp: 1350,
        passiveId: 'orig_lady_flemeth',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Lady%20Flemeth',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Rayo',
        cardClass: 'Robot',
        hp: 5900, def: 1150, atq: 200,
        maxHp: 5900,
        passiveId: 'orig_omega',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Omega',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_sacred_del_vacio',
        name: 'Sacred del Vacío',
        element: 'Oscuridad',
        cardClass: 'Spectre',
        hp: 1700, def: 550, atq: 550,
        maxHp: 1700,
        passiveId: 'orig_sacred_del_vacio',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Sacred%20del%20Vac%C3%ADo',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_natsuki_del_vacio',
        name: 'Natsuki del Vacío',
        element: 'Oscuridad',
        cardClass: 'Spectre',
        hp: 1700, def: 550, atq: 550,
        maxHp: 1700,
        passiveId: 'orig_natsuki_del_vacio',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Natsuki%20del%20Vac%C3%ADo',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_didack_del_vacio',
        name: 'Didack del Vacío',
        element: 'Oscuridad',
        cardClass: 'Spectre',
        hp: 1700, def: 550, atq: 550,
        maxHp: 1700,
        passiveId: 'orig_didack_del_vacio',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Didack%20del%20Vac%C3%ADo',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Oscuridad',
        cardClass: 'Dragon',
        hp: 3850, def: 1650, atq: 800,
        maxHp: 3850,
        passiveId: 'orig_aatrox',
        ultimateId: '',
        ultimateLevel: 1,
    ...
    {
        id: 'hero_act_amateratsu',
        name: 'Amateratsu',
        element: 'Luz',
        cardClass: 'Human',
        hp: 2900, def: 1250, atq: 3200,
        maxHp: 2900,
        passiveId: 'orig_amateratsu',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Amateratsu',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_theradeus',
        name: 'Theradeus',
        element: 'Agua',
        cardClass: 'Monster',
        hp: 50, def: 3600, atq: 2400,
        maxHp: 50,
        passiveId: 'orig_theradeus',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Theradeus',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_cerberus',
        name: 'Cerberus',
        element: 'Oscuridad',
        cardClass: 'Beast',
        hp: 2150, def: 2150, atq: 2150,
        maxHp: 2150,
        passiveId: 'orig_cerberus',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Cerberus',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_libelula',
        name: 'Libelula',
        element: 'Naturaleza',
        cardClass: 'Beast',
        hp: 2050, def: 2050, atq: 2050,
        maxHp: 2050,
        passiveId: 'orig_libelula',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Libelula',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Rayo',
        cardClass: 'Human',
        hp: 650, def: 2250, atq: 3150,
        maxHp: 650,
        passiveId: 'orig_riven',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Riven',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Rayo',
        cardClass: 'Robot',
        hp: 2450, def: 2450, atq: 2450,
        maxHp: 2450,
        passiveId: 'orig_zero',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Zero',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        hp: 1700, def: 550, atq: 550,
        maxHp: 1700,
        passiveId: 'orig_selene',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Selene',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        hp: 1700, def: 550, atq: 550,
        maxHp: 1700,
        passiveId: 'orig_misha',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Misha',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
    ...
    },
    {
        ...
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Tera',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        hp: 1700, def: 550, atq: 550,
        maxHp: 1700,
        passiveId: 'orig_megan',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Megan',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Rayo',
        cardClass: 'Robot',
        hp: 2100, def: 1250, atq: 3900,
        maxHp: 2100,
        passiveId: 'orig_xen',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Xen',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_myrmidon',
        name: 'Myrmidon',
        element: 'Fuego',
        cardClass: 'Human',
        hp: 1150, def: 4950, atq: 1250,
        maxHp: 1150,
        passiveId: 'orig_myrmidon',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Myrmidon',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        ...
        element: 'Oscuridad',
        cardClass: 'Monster',
        hp: 450, def: 1100, atq: 650,
        maxHp: 450,
        passiveId: 'orig_zombie',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Zombie',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
    {
        id: 'hero_act_drakonnan',
        name: 'Drakonnan',
        element: 'Fuego',
        cardClass: 'Dragon',
        hp: 800, def: 800, atq: 800,
        maxHp: 800,
        passiveId: 'orig_drakonnan',
        ultimateId: '',
        ultimateLevel: 1,
        image: 'https://via.placeholder.com/300x200?text=Drakonnan',
        _official: true,
        description: 'Carta original del primer diseño de Easy Hit (Easy Hit ACT).'
    },
];
